...
import { request, subscribe, inVSCode, initialRoute, rememberRoute } from './platform.js';
...
function App() {
  ...
  const location = useLocation(); const coding = /^\/(lesson|learn|quiz|practice|project|assignment)\//.test(location.pathname);
  ...
  if (!inVSCode) return <main className="page-shell"><h1>Pip lives in VS Code.</h1><p>Install the Pip Workshop VSIX, open a learning folder, and run <b>Pip: Open Course</b> from the Command Palette.</p><p>This page is only a visual preview. Java editing and execution are provided by VS Code.</p></main>;
